...
function query(text_1) {
    return __awaiter(this, arguments, void 0, function* (text, params = [], tenantId = null) {
        const client = yield pool.connect();
        try {
            // Set tenant context for Row Level Security if provided
            if (tenantId) {
                yield client.query('SET app.current_tenant_id = $1', [tenantId]);
            }
            ...
            if (tenantId) {
                yield client.query('RESET app.current_tenant_id');
            }
            client.release();
        }
    });
 ...
 */
function transaction(callback_1) {
    return __awaiter(this, arguments, void 0, function* (callback, tenantId = null) {
        const client = yield pool.connect();
        try {
...
function testConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            const result = yield query('SELECT NOW() as current_time, version() as pg_version');
