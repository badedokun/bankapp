...
const InternalTransferService_1 = __importDefault(require("../services/transfers/InternalTransferService"));
...
const initializeTransferServices = (db) => {
    transferServices.internal = new InternalTransferService_1.default(db);
...
router.post('/internal', auth_1.authenticateToken, tenant_1.validateTenantAccess, [
    ...
    try {
        ...
        const result = await transferServices.internal.processTransfer(request, req.user.id);
        res.status(200).json({
            success: true,
...
router.post('/bills', auth_1.authenticateToken, tenant_1.validateTenantAccess, [
    ...
    try {
        const request = {
            type: 'bill_payment',
            senderAccountId: req.body.senderAccountId,
            recipientName: req.body.billerName,
            amount: parseFloat(req.body.amount),
            description: req.body.description,
            pin: req.body.pin,
            ...
            billCategory: req.body.billCategory,
        };
...
router.post('/international', auth_1.authenticateToken, tenant_1.validateTenantAccess, [
    ...
    try {
        const request = {
            ...
            recipientSwiftCode: req.body.recipientSwiftCode,
