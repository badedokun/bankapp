...
exports.InteracProvider = void 0;
const axios_1 = __importDefault(require("axios"));
const crypto = __importStar(require("crypto"));
const IPaymentProvider_1 = require("./IPaymentProvider");
class InteracProvider extends IPaymentProvider_1.BasePaymentProvider {
    constructor() {
        super(...arguments);
        this.name = 'Interac';
        this.region = 'Canada';
     ...
     */
    parseCanadianAccount(accountString) {
     ...
     */
    getBankNameFromInstitution(institutionNumber) {
     ...
     */
    async mockInteracValidation(account) {
...
exports.InteracProvider = InteracProvider;
//# sourceMappingURL=InteracProvider.js.map