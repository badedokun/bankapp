...
exports.USAComplianceProvider = void 0;
...
class USAComplianceProvider extends IComplianceProvider_1.BaseComplianceProvider {
    constructor() {
        super(...arguments);
        this.name = 'USA Compliance Provider';
        this.region = 'USA';
        this.country = 'US';
        this.capabilities = {
            supportsKYC: true,
    ...
    async performKYC(request) {
        ...
        if (level === 'basic') {
            ...
            const primaryId = documents.find(d => d.type === 'drivers_license' || d.type === 'passport');
            if (primaryId) {
    ...
    async performCreditBureauCheck(user) {
        // Mock credit bureau check (Experian/Equifax/TransUnion)
    ...
    getSubmissionTarget(reportType) {
        switch (reportType) {
            case 'SAR':
            case 'CTR':
...
exports.USAComplianceProvider = USAComplianceProvider;
//# sourceMappingURL=USAComplianceProvider.js.map