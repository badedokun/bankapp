...
class AIActionsService {
     ...
     */
    static async processTransferIntent(userId, message, parameters = {}) {
        try {
            ...
            const missingFields = [];
            if (!mergedParams.amount)
                missingFields.push('amount');
            if (!mergedParams.recipientAccount)
                missingFields.push('recipient account number');
            if (!mergedParams.recipientName)
     ...
     */
    static extractTransferParameters(message) {
        const params = {};
     ...
     */
    static buildPromptMessage(params, missingFields) {
        const knownInfo = [];
        if (params.amount) {
            const formattedAmount = new Intl.NumberFormat('en-NG', {
                style: 'currency',
     ...
     */
    static getTransferSuggestions(_params, missingFields) {
        const suggestions = [];
     ...
     */
    static async processBillPaymentIntent(userId, message, parameters = {}) {
        // Extract bill type
     ...
     */
    static async processActionIntent(intent, userId, message, parameters = {}) {
        switch (intent) {
            case 'transfer_money':
...
exports.default = AIActionsService;
//# sourceMappingURL=AIActionsService.js.map