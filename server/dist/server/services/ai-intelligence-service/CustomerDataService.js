...
exports.CustomerDataService = void 0;
...
class CustomerDataService {
     ...
     */
    static async getBalance(userId, tenantId) {
        try {
     ...
     */
    static async analyzeSpending(userId, tenantId, days = 30) {
        try {
            // Get spending by category (spending types: withdrawals, transfers, payments, etc.)
            const categoryResult = await multi_tenant_database_1.default.queryTenant(tenantId, `SELECT
        ...
        LIMIT 10`, [userId]);
            ...
            const statsResult = await multi_tenant_database_1.default.queryTenant(tenantId, `SELECT
     ...
     */
    static async getSavingsInfo(userId, tenantId) {
        try {
            const result = await multi_tenant_database_1.default.queryTenant(tenantId, `SELECT
          id,
          goal_name,
     ...
     */
    static async processQuery(message, userId, tenantId, options) {
